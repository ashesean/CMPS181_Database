...
// Class that I've added. Just has some general helper functions.
class Helper
{
public:
    bool checkCondition(vector<Attribute> attrs, const void *data, const Condition &condition);
    bool compareInts(const void *lhs, const void *rhs, CompOp op);
    bool compareFloats(const void *lhs, const void *rhs, CompOp op);
    bool compareStrings(const void *lhs, const void *rhs, CompOp op);
...
public:
    ...
    ~NLJoin(){ free(leftTuple); free(rightTuple); };
